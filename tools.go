...
// Tools is the type used to instantiate this module. Any variable of this type will have the access to
// all th the methods of the reciever *Tools
type Tools struct {
	MaxFileSize        int
...
// DownloadStaticFile downloads a static file and tries to force the browser to avoid displaying it
...
// JSONResponse is the type used for sending JSON responses
...
func (t *Tools) ReadJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	...
	if err != nil {
		...
		case err.Error() == "htt: request body too large":
...
// ErrorJSON takes an error, and optionally a status code, and generates and send a JSON error message
...
// The final parameter, client is optional. if none specified, we use the standard http.client
